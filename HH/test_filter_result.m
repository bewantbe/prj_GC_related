...
[A, B] = custom_filters('butter_o=10_wc1=0.02_wc2=0.15', true);  % stop the signal in high freq. GC.
X_l = filter(B',A',oX')';
X_l = X_l(:, 1:i_stv:end);
...
od_l = 50;  % for near singular case
%od_l = 16;  % for zero eliminated spectrum
[srd_l a_X_l] = WhiteningFilter(X_l, od_l, 'qr'); % better result, but much slower
